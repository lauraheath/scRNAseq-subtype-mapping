...
counts <- readRDS(file="~/scRNAseq-subtype-mapping/data_objects/glialcellsF_samplecorrected_orderedmerge.RDS")
...
DEgenes <- read.csv(file='~/scRNAseq-subtype-mapping/data_objects/astro_DE_genesALL.csv')
...
#Astrocyes females: root at state 9
...
MonRun$State2[MonRun$State == 4] <- 2
MonRun$State2[MonRun$State == 8] <- 2
