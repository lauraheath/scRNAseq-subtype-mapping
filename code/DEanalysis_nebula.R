...
#seurat <- readRDS(file='~/scRNAseq-subtype-mapping/data_objects/allcellsF_Seurat.RDS')
seurat <- readRDS(file='~/scRNAseq-subtype-mapping/data_objects/allcellsM_Seurat.RDS')


#seurat2 <- subset(seurat, reclassify=='Micro-PVM')
seurat2 <- subset(seurat, reclassify=='Astro')
...
#pstimes <- read.csv(file='~/scRNAseq-subtype-mapping/data_objects/AstroF_samplecorrected_pstimeStates.csv', row.names=F)
pstimes <- read.csv(file='~/scRNAseq-subtype-mapping/data_objects/AstroM_samplecorrected_pstimeStates.csv, row.names=F')
...
################for Astrocytes F and M: five total states, run nebula 4 times #####################
...
results <- rbind(model1sum, model2sum, model3sum, model4sum)
...
#write.csv(results, file="~/scRNAseq-subtype-mapping/DEresults/astrocyteF_samplecorrected_DEresults.csv")
#write.csv(model1sum, file="~/scRNAseq-subtype-mapping/DEresults/astrocyteF_samplecorrected_ReferenceResults.csv")

write.csv(results, file="~/scRNAseq-subtype-mapping/DEresults/astrocyteM_samplecorrected_DEresults.csv")
write.csv(model1sum, file="~/scRNAseq-subtype-mapping/DEresults/astrocyteM_samplecorrected_ReferenceResults.csv")
